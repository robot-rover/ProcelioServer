...
public class Usertable extends TableImpl<UsertableRecord> {
    ...
    private static final long serialVersionUID = 999146960;
     ...
     */
    public final TableField<UsertableRecord, String> INVENTORY = createField("INVENTORY", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>usertable.ROBOTS</code>.
     */
    public final TableField<UsertableRecord, String> ROBOTS = createField("ROBOTS", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
