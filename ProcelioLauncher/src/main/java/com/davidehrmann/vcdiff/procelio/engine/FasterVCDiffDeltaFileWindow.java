...
package com.davidehrmann.vcdiff.procelio.engine;

import com.davidehrmann.vcdiff.procelio.engine.VCDiffCodeTableData;
import com.davidehrmann.vcdiff.procelio.engine.VCDiffCodeTableReader;
import com.davidehrmann.vcdiff.procelio.engine.VCDiffHeaderParser;
...
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffCodeTableData.VCD_ADD;
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffCodeTableData.VCD_COPY;
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffCodeTableData.VCD_INSTRUCTION_END_OF_DATA;
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffCodeTableData.VCD_RUN;
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffCodeTableWriterImpl.VCD_CHECKSUM;
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffCodeTableWriterImpl.VCD_SOURCE;
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffCodeTableWriterImpl.VCD_TARGET;

@SuppressWarnings("UnnecessaryInitCause")
class FasterVCDiffDeltaFileWindow {
    private static final Logger LOGGER = LoggerFactory.getLogger(FasterVCDiffDeltaFileWindow.class);

    public FasterVCDiffDeltaFileWindow(FasterVCDiffStreamingDecoderImpl parent) {
    ...
    private int readHeader(ByteBuffer parseableChunk) throws IOException {
        ...
        //
        FasterVCDiffStreamingDecoderImpl.DecoratedByteArrayOutputStream decoded_target = parent.decodedTarget();
    ...
    private final FasterVCDiffStreamingDecoderImpl parent;
