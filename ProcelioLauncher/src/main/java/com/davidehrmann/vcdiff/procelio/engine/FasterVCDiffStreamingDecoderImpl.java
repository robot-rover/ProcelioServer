...
import com.davidehrmann.vcdiff.engine.*;
...
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffHeaderParser.RESULT_END_OF_DATA;
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffHeaderParser.RESULT_SUCCESS;
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffHeaderParser.VCD_CODETABLE;
import static com.davidehrmann.vcdiff.procelio.engine.VCDiffHeaderParser.VCD_DECOMPRESS;

@SuppressWarnings("ALL")
public class FasterVCDiffStreamingDecoderImpl implements VCDiffStreamingDecoder {
    ...
    private FasterVCDiffDeltaFileWindow deltaWindow;
    ...
    private FasterVCDiffStreamingDecoderImpl custom_code_table_decoder_;
    ...
    public FasterVCDiffStreamingDecoderImpl() {
        deltaWindow = new FasterVCDiffDeltaFileWindow(this);
        reset();
    }
    ...
    private int InitCustomCodeTable(byte[] data_start, int offset, int length) throws IOException {
        ...
        custom_code_table_decoder_ = new FasterVCDiffStreamingDecoderImpl();
    ...
    private void appendNewOutputText(OutputStream out) throws IOException {
        ...
        out.write(decodedTargetBuffer.array(),  decodedTargetBuffer.position(), decodedTargetBuffer.remaining());
